...
plot(degs,GrpTime-GrpTime_n0,'-o','linewidth',2,'color','r')
hold on
ylim([-100 100])
xlim([5 150])
...
grid on; box on;
title(['T = ' num2str(period) ' s'])



end
xlabel('Epicentral Distance (deg)')
sgtitle('Varying Period','fontweight','bold')
set(gcf,'position',[37 54 319 809])

saveas(gcf,'VaryingPeriod.eps','epsc')