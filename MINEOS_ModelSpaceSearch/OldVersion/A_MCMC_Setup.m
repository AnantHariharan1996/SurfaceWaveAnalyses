...
for ijk = 1:NLayers_Model
ModelInfoStruc(ijk).TrialVsh_List = [];
ModelInfoStruc(ijk).Accepted_List = [];
...
Vsh_Prior_Edges = [2000 6000;
                    ...
                    2000 6000;
                    2000 6000];
Perturb_VeloList = [500 500 500 500];
StoreCounter=1;
...
card=read_model_card('Card_Files/prem_35.card');
jnkjnk=card.z;
depthdx = find(jnkjnk > 50 & jnkjnk< 90);
